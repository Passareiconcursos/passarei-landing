...
const EXPANSION: Record<string, ContentItem[]> = {
  ...
  // REDAÇÃO (10 → 20 = +10)
  REDACAO: [
    { title: "Estrutura da Dissertação-Argumentativa", textContent: "Formato padrão de redação para concursos e ENEM. Introdução: contextualização + tese (posicionamento). Desenvolvimento (2-3 parágrafos): argumentos com evidências. Conclusão: retomada da tese + proposta de intervenção. Estrutura: apresentação → argumentação → conclusão. Mínimo: 20 linhas. Máximo: 30 linhas.", difficulty: "FACIL" },
    { title: "Competências da Redação do ENEM", textContent: "5 competências, 200 pontos cada: C1 (norma culta), C2 (compreensão do tema e gênero dissertativo), C3 (organização e argumentação), C4 (coesão textual: conectivos), C5 (proposta de intervenção: agente, ação, meio, detalhamento, finalidade). Nota máxima: 1.000 pontos. Nota zero: fuga ao tema, texto insuficiente.", difficulty: "MEDIO" },
    ...
    { title: "Proposta de Intervenção (ENEM)", textContent: "Obrigatória na conclusão. 5 elementos: agente (quem vai agir: governo, escola, sociedade), ação (o que fazer), meio/modo (como), detalhamento (especificar um dos elementos), finalidade (para quê). Deve respeitar direitos humanos. Proposta genérica perde pontos. Quanto mais específica e viável, melhor.", difficulty: "MEDIO" },
    ...
    { title: "Temas Frequentes de Redação", textContent: "ENEM: saúde mental, tecnologia e privacidade, violência, educação, meio ambiente, invisibilidade social. Concursos: segurança pública, reforma do Estado, ética, combate à corrupção, direitos fundamentais. Dica: ler notícias, editais, redações nota 1.000. Manter repertório atualizado com dados e citações.", difficulty: "MEDIO" },
