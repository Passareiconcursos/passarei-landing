...
\restrict chZLsog8sJjb9jsTgQ9zrWfYqYbbTBK2KCseuQEWccoIX02ZdysjcP0rzI1waAc
...
ALTER TYPE public."CargoLevel" OWNER TO postgres;
...
ALTER TYPE public."StudyLevel" OWNER TO postgres;
...
ALTER TYPE public."SubjectCategory" OWNER TO postgres;
...
ALTER TABLE public."CargoSubject" OWNER TO postgres;
...
ALTER TABLE public."Essay" OWNER TO postgres;
...
ALTER TABLE public."PerformanceStats" OWNER TO postgres;
...
ALTER TABLE public."SpacedReview" OWNER TO postgres;
...
ALTER TABLE public."StudyPlan" OWNER TO postgres;
...
ALTER TABLE public."StudyPlanItem" OWNER TO postgres;
...
ALTER TABLE public."StudySession" OWNER TO postgres;
...
COPY public."Admin" (id, email, password, name, role, "isActive", "createdAt", "updatedAt") FROM stdin;
cmichek920000t8ud4fqd6gc0	admin@passarei.com	$2b$10$eHGV2xqU//cDVDl6G0X4X.NYYnHUGUNz0JsZ80rog2oqsvlMyNUE6	Admin Teste	SUPER_ADMIN	t	2025-11-24 01:41:59.175	2025-11-24 15:54:44.216
\.
...
COPY public."AdminSession" (id, "adminId", token, "expiresAt", "createdAt") FROM stdin;
...
COPY public."AuditLog" (id, "adminId", action, details, "createdAt") FROM stdin;
...
COPY public."Cargo" (id, name, "displayName", description, organization, state, level, "editalUrl", "totalVagas", salario, "isActive", "createdAt", "updatedAt") FROM stdin;
cmichej6u0008rpiykxycg8k7	PM-SP-SOLDADO	PM-SP - Soldado	\N	PM	SP	MEDIO	\N	\N	3192.00	t	2025-11-24 01:41:57.798	2025-11-24 01:41:57.798
cmichej760009rpiyjsd4muhh	PRF-AGENTE	PRF - Agente	\N	PRF	\N	SUPERIOR	\N	\N	9300.00	t	2025-11-24 01:41:57.81	2025-11-24 01:41:57.81
\.
...
COPY public."CargoSubject" (id, "cargoId", "subjectId", weight, "numberOfQuestions") FROM stdin;
\.
...
COPY public."Content" (id, "subjectId", "topicId", title, "textContent", difficulty, "wordCount", "estimatedReadTime", "audioUrl", "audioDuration", "isActive", version, "createdAt", "updatedAt") FROM stdin;
\.
...
COPY public."Essay" (id, "userId", theme, prompt, text, "wordCount", "correctedAt", score1, score2, score3, score4, score5, "totalScore", feedback, status, "createdAt", "updatedAt") FROM stdin;
\.
...
COPY public."Interaction" (id, "userId", "messageType", content, intent, confidence, "contextData", "responseTime", "timestamp") FROM stdin;
\.
...
COPY public."Lead" (id, name, email, phone, "examType", state, status, source, notes, "assignedToId", "utmSource", "utmMedium", "utmCampaign", "acceptedWhatsApp", "createdAt", "updatedAt") FROM stdin;
cmidan1g900004nv61uob4vee	Maria Santos	maria1763997623@teste.com	11988888888	PRF	RJ	NOVO	landing_page	\N	\N	\N	\N	\N	t	2025-11-24 15:20:23.577	2025-11-24 15:20:23.577
\.
...
COPY public."Notification" (id, "userId", type, title, message, "scheduledFor", "sentAt", status, metadata, "createdAt", "updatedAt") FROM stdin;
\.
...
COPY public."PerformanceStats" (id, "userId", "periodType", "periodStart", "periodEnd", "daysActive", "contentsStudied", "questionsAnswered", "questionsCorrect", "accuracyRate", "totalStudyTime", "currentStreak", "maxStreak", "subjectStats", improvement, "createdAt", "updatedAt") FROM stdin;
\.
...
COPY public."Plan" (id, name, "displayName", description, "priceMonthly", "priceYearly", "dailyContentLimit", "dailyCorrectionLimit", "dailyEssayLimit", features, "allowsAffiliate", "affiliateCommission", "isActive", "sortOrder", "createdAt", "updatedAt") FROM stdin;
cmichej450000rpiywaqsyx29	FREE	Plano Gratuito	Experimente o Passarei gratuitamente	0.00	0.00	2	2	0	"[\\"Onboarding\\",\\"2 matérias/dia\\"]"	f	\N	t	1	2025-11-24 01:41:57.701	2025-11-24 01:41:57.701
cmichej5g0001rpiyttqlcgte	CALOURO	Plano Calouro	Para quem está começando	12.90	\N	10	10	1	"[\\"10 matérias/dia\\",\\"1 redação/dia\\"]"	f	\N	t	2	2025-11-24 01:41:57.748	2025-11-24 01:41:57.748
cmichej5m0002rpiy5x9wbicz	VETERANO	Plano Veterano	Para concurseiros dedicados	9.90	118.80	30	30	3	"[\\"30 matérias/dia\\",\\"3 redações/dia\\",\\"Afiliados 20%\\"]"	t	20.00	t	3	2025-11-24 01:41:57.755	2025-11-24 01:41:57.755
\.
...
COPY public."Question" (id, "subjectId", "topicId", statement, "questionType", alternatives, "correctAnswer", explanation, "wrongExplanations", difficulty, "examBoard", "examYear", "examName", tags, "isActive", "timesUsed", "createdAt", "updatedAt") FROM stdin;
\.
...
COPY public."QuestionAttempt" (id, "userId", "questionId", "userAnswer", "isCorrect", "timeSpent", "attemptType", "reviewAttempt", "createdAt") FROM stdin;
\.
...
COPY public."SpacedReview" (id, "userId", "contentId", "questionId", "topicId", "scheduledFor", "completedAt", "reviewNumber", "interval", "easinessFactor", quality, "wasSuccessful", status, "createdAt", "updatedAt") FROM stdin;
\.
...
COPY public."StudyPlan" (id, "userId", name, description, "basedOnEdital", "editalUrl", "startDate", "endDate", "isActive", "isCompleted", "createdAt", "updatedAt") FROM stdin;
\.
...
COPY public."StudyPlanItem" (id, "studyPlanId", "subjectId", priority, "sortOrder", weight, "numberOfQuestions", "targetProgress", "currentProgress", "isCompleted", "createdAt", "updatedAt") FROM stdin;
\.
...
COPY public."StudySession" (id, "userId", "startTime", "endTime", duration, "contentsViewed", "questionsAnswered", "questionsCorrect", "deviceInfo", "createdAt", "updatedAt") FROM stdin;
\.
...
COPY public."Subject" (id, name, "displayName", description, category, "isActive", "sortOrder", "createdAt", "updatedAt") FROM stdin;
cmichej5t0003rpiy2giws0j9	PORTUGUES	Língua Portuguesa	\N	LINGUAGENS	t	0	2025-11-24 01:41:57.761	2025-11-24 01:41:57.761
cmichej610004rpiyjq7iswhn	MATEMATICA	Matemática	\N	MATEMATICA	t	1	2025-11-24 01:41:57.769	2025-11-24 01:41:57.769
cmichej6a0005rpiyxqjqmyzr	DIR_CONSTITUCIONAL	Direito Constitucional	\N	DIREITO	t	2	2025-11-24 01:41:57.778	2025-11-24 01:41:57.778
cmichej6f0006rpiyqzrso6dc	DIR_ADMINISTRATIVO	Direito Administrativo	\N	DIREITO	t	3	2025-11-24 01:41:57.784	2025-11-24 01:41:57.784
cmichej6m0007rpiyf4nkyj67	DIR_PENAL	Direito Penal	\N	DIREITO	t	4	2025-11-24 01:41:57.79	2025-11-24 01:41:57.79
\.
...
COPY public."Subscription" (id, "userId", "planId", status, "startDate", "endDate", "paymentMethod", "paymentId", "autoRenew", "renewalDate", "canceledAt", "cancelReason", "createdAt", "updatedAt") FROM stdin;
\.
...
COPY public."Topic" (id, "subjectId", name, description, "sortOrder", "createdAt", "updatedAt") FROM stdin;
\.
...
COPY public."Transaction" (id, "subscriptionId", amount, currency, "gatewayId", "gatewayName", status, "paidAt", "affiliateId", "commissionAmount", "commissionPaid", metadata, "createdAt", "updatedAt") FROM stdin;
\.
...
COPY public."User" (id, phone, name, email, "isActive", "isBanned", "banReason", "isAffiliate", "affiliateCode", "referredBy", "createdAt", "updatedAt") FROM stdin;
\.
...
COPY public."UserFeedback" (id, "userId", type, rating, comment, "relatedContentId", "relatedQuestionId", "createdAt") FROM stdin;
\.
...
COPY public."UserProfile" (id, "userId", "cargoId", state, "examDate", "editalUrl", "editalAnalyzed", "availableTimeDaily", "studyLevel", "preferredSchedules", "strongSubjects", "weakSubjects", "allowNotifications", "allowMotivation", "allowAudios", timezone, "planJson", "createdAt", "updatedAt") FROM stdin;
\.
...
COPY public."UserProgress" (id, "userId", "contentId", status, "viewCount", "lastViewedAt", "quizAttempts", "quizCorrect", "needsReview", "nextReviewAt", "reviewInterval", "easinessFactor", "hasDoubt", notes, "createdAt", "updatedAt") FROM stdin;
\.
...
\unrestrict chZLsog8sJjb9jsTgQ9zrWfYqYbbTBK2KCseuQEWccoIX02ZdysjcP0rzI1waAc
