...
export function Pricing() {
  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        "Realize + de 3.000 mil questões ano",
    ...
    },
    {
      ...
      features: [
        "Realize + de 10.000 mil questões ano",
        "2 correções e dicas de redação/mês Gratuitas",
        "Método de memorização sm2",
        "Simulados semanais e mensais",
        "Intensivo nas suas dificuldades",
        "Milhares de Questões das bancas corrigidas",
        "Suporte prioritário",
        "Troque de concurso quando quiser",
        "Cursos tradicionais custam até 80% mais",
      ],
